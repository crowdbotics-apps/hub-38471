"""
Django settings for hub_38471 project.
...
WSGI_APPLICATION = 'hub_38471.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hub_38471 API",
    "DESCRIPTION": "API documentation for hub_38471 App",
    "VERSION": "v1",
}
